            ...
            <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                ...
                <div class="row">
                        ...
                        <?php
                        	...
                        	$update_msg = mysqli_query($con , "UPDATE   `users_chat` where  SET msg_status='read'
      	...
      	<div class ="row">
                <div class="col-md-12 right-chat-textbox">
					<form method="post">
						...
						<input type="text"  autocomplete="off" name="msg_content" placeholder="Write message here ...">
    ...
    <?php
         ...
         if(isset($_POST['submit']))
         {
             ...
             else
             {
                 ...
                 $insert ="INSERT INTO `users_chat` ( sender_username, receiver_username, msg_content, msg_status, 
                 msg_date) VALUES ('$user_name', '$username', '$msg', 'unread', NOW())";
    ...
    ?>
        ...
        <script type="text/javascript">
            $(document).ready(function()
            {
                ...
                $('.right-header-contentChat').css('height',(height - 300)+ 'px');
             });
            </script>
</body>
</html>
