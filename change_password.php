            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <table class="table table-bordered table-hover" >
                    ...
                    <tr>
                        ...
                        <td>
                          <input type="password" name="current_pass" class="form-control" id="mypass" required placeholder="
                          Current Password"/>
                        </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                              <input type="password" name="u_pass1" class="form-control"  id="mypass" required placeholder="
                              New Password"/>
                            </td>
                            </tr>

                            <tr>
                                <td style="font-weight: bold;">Confirm Password
                                </td>
                                <td>
